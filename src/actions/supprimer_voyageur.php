...
// empecher un utilisateur de supprimer son propre profil skieur principal
...
try {
    // verifier si ce voyageur appartient bien au carnet d'adresses de cet utilisateur
    ...
    if (!$stmtCheck->fetch()) {
        $_SESSION['error'] = "Action non autorisee : ce voyageur ne fait pas partie de votre tribu.";
        header("Location: ../pages/carnet.php");
        exit();
    }
    ...
    $_SESSION['success'] = "Le voyageur a ete supprime de votre tribu avec succes.";
