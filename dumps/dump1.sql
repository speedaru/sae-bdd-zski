-- ==========================================================
-- Script de création de la base de données Zarza-Ski (V2)
-- Basé sur le nouveau MLD fourni
-- ==========================================================
...
taille NUMERIC(3,2) NOT NULL, -- en mètres (ex: 1.80)
poids SMALLINT NOT NULL,      -- en kg
pointure NUMERIC(3,1) NOT NULL -- ex: 42.5
);
...
-- Table centrale 'reserver' selon le MLD
...
PRIMARY KEY (id_client, id_reservation) -- Un client ne peut avoir qu'une réservation par période
);
